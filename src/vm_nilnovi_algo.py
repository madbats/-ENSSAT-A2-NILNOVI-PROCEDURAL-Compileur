...
def get():
    ...
    try:
        ...
        print("\033[91mERROR\033[0m: Integer expected \033[91m" +
              str(val)+"\033[0m given")
        erreur()
...
def traStat(a, nbp):
    ...
    pile[base + 1] = co + 1
    co = int(a) - 1
    # logger.debug("ip after traStat = " + str(ip) + " co: "+str(co))
...
def retourProc():
    ...
    # logger.debug("co after retourProc = " + str(co))
...
def main():
    ...
    while co < len(stack):
        ...
        logger.debug(
            "\033[92mbase: \033[92m%s \033[93mip: \033[93m%s\033[0m - \033[94m%s\033[0m", str(base), str(ip), str(pile))
